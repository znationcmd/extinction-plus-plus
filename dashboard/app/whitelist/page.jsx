        ...
        <div className="card">
          ...
          {!servers.length && (
            <p className="text-white/60">
              Aucun serveur whitelist configuré.
            </p>
          )}
            ...
            {servers.map((s, i) => (
              ...
              >
                <p className="font-bold">
                  {s.name || s.server_name || 'Serveur sans nom'}
                </p>
                ...
                <p>
                  Plateforme :{' '}
                  {s.platform || s.plateforme || s.game || 'inconnue'}
                </p>

                <p>
                  ID Nitrado :{' '}
                  {s.nitradoServiceId ||
                    s.nitrado_service_id ||
                    s.service_id ||
                    'non renseigné'}
                </p>
              </div>
        ...
        <div className="card">
          ...
          <div className="grid gap-3">
            {requests.map((r, i) => (
              ...
              >
                <p className="font-bold">
                  Discord : {r.guildId || r.guild_id || 'inconnu'}
                </p>

                <p>
                  Joueur Discord :{' '}
                  {r.userId || r.user_id || r.discord_id || 'inconnu'}
                </p>

                <p>
                  Serveur :{' '}
                  {r.server || r.server_name || r.server_id || 'inconnu'}
                </p>
                ...
                <p>
                  Plateforme :{' '}
                  {r.plateforme || r.platform || 'inconnue'}
                </p>

                <p>
                  Pseudo / ID :{' '}
                  {r.pseudo || r.steam_id || r.uid || 'non renseigné'}
                </p>

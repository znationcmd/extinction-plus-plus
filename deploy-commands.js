...
const commands = [
  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand(sc => sc.setName('connect').setDescription('Connecter le compte Nitrado de ce Discord')
      .addStringOption(o => o.setName('token').setDescription('Token API Nitrado du propriétaire').setRequired(true)))
    .addSubcommand(sc => sc.setName('disconnect').setDescription('Supprimer le token Nitrado de ce Discord'))
    .addSubcommand(sc => sc.setName('status').setDescription('Voir si Nitrado est connecté pour ce Discord'))
    .addSubcommand(sc => sc.setName('test').setDescription('Tester le token Nitrado du Discord'))
    .addSubcommand(sc => sc.setName('services').setDescription('Lister les services Nitrado du Discord'))
    .addSubcommand(sc => sc.setName('link-server').setDescription('Lier un serveur Nitrado au Discord')
      .addStringOption(o => o.setName('service_id').setDescription('ID service Nitrado').setRequired(true))
      .addStringOption(o => o.setName('nom').setDescription('Nom visible du serveur').setRequired(true))
      .addStringOption(o => o.setName('jeu').setDescription('Jeu').setRequired(true).addChoices(...games))
      .addStringOption(o => o.setName('map').setDescription('Map').setRequired(false))
      .addStringOption(o => o.setName('whitelist_path').setDescription('Chemin whitelist.txt DayZ PC si utilisé').setRequired(false)))
